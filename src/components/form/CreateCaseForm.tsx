...
function CreateCaseForm({ isLoading, setIsLoading }: CreateCaseFormProps) {
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="Missing Module">
                          Missing Module
                        </SelectItem>
                        <SelectItem value="Remove Module">
                          Remove Module
                        </SelectItem>
